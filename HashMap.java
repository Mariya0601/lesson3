...
public class HashMap<K, V> implements Iterable<HashMap<K, V>.Entity> {
    ...
    public static void main(String[] args) {
        ...
        hashMap.put("John", "Lennon");
        hashMap.put("Paul","McCartney");
        hashMap.put("George","Harrison");
        hashMap.put("Ringo","Starr");
        hashMap.put("Freddie","Mercury");
        hashMap.put("Brian","May");
        hashMap.put("Roger","Taylor");
        hashMap.put("John","Deacon");
        hashMap.put("Jon","Lord");
        hashMap.put("Ritchie","Blackmore");
        hashMap.put("Ian","Gillan");
        hashMap.put("Ian","Paice");
        hashMap.put("Roger","Glover");

//        for (HashMap<String, String>.Entity entity :
//                hashMap) {
